...
/**
 * This class only has one method, which will be calling the method to make
 * connection with R and gives the parameters to the function in the R-script.
 *
 * @author jwlgoh
 */
public class CallRMethods {
    ...
    /**
     * Upon receiving the parameters, this method will be calling the function
     * in the R-script with the needed parameters for the calculations.
     *
     * @param tmp_dir
     * @param noaPath
     * @param options
